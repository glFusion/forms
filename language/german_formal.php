...
$LANG_FORMS = array(
  ...
  'cancel' => 'Abbruch',
  'columns' => 'Spalten',
  'confirm_delete' => 'Sind Sie sich sicher, diesen Eintrag löen zu wollen?',
  'confirm_form_delete' => 'Sie sind sicher, dass Sie dieses Formular löen wollen? Alle zugehöen Felder und Daten werden gelöt.',
  'datetime' => 'Datum/Zeit',
  'day' => 'Tag',
  'def_submit_msg' => 'Danke füen Formularvorschlag',
  ...
  'hdr_field_list' => 'Ein Datenfeld auswäen, um es zu bearbeiten. Um ein Neues zu erstellen, klicken Sie auf "Neues Datenfeld" oben.',
  'hdr_form_list' => 'Ein Formular auswäen, um es zu bearbeiten. Um ein Neues zu erstellen, klicken Sie auf "Neues Formular" oben.  Andere verfü Aktionen sind in der Auswahl unten aufgefü',
  'hdr_form_preview' => 'Dies ist eine voll funktionsfäge Vorschau, wie das Formular aussieht.  Wenn Sie die Datenfelder ausfüund den Button »Üertragen/Submit« klicken, werden die Daten gespeichert und/oder die Formularbesitzer per E-Mail benachrichtigt',
  'hdr_form_results' => 'Hier sind die Ergebnisse fü Formular.  Um Datenfelder zu löen, markieren Sie die betreffenden Kontrollkächen und wäen Sie "Löen".',
  'help_msg' => 'Help Text',
  'hidden' => 'Hidden',
  ...
  'no' => 'Nein',
  'noaccess_msg' => 'Sie haben keine Berechtigung füses Formular',
