...
$LANG_FORMS = array(
  'action' => 'weiter mit',
  'add_century' => 'Jahrhundert verwenden, wenn Datum unvollstäig',
  ...
  'cancel' => 'Abbruch',
  'columns' => 'Spalten',
  'confirm_delete' => 'Bist Du dir sicher, diesen Eintrag löen zu wollen?',
  'confirm_form_delete' => 'Bist Du sicher, dass Du dieses Formular löen willst? Alle zugehöen Felder und Daten werden gelöt.',
  'datetime' => 'Datum/Zeit',
  'day' => 'Tag',
  'def_submit_msg' => 'Danke fünen Formularvorschlag',
  'defvalue' => 'Standardwert',
  'del_selected' => 'Auswahl löen',
  ...
  'fieldset1' => 'Zusäliche Formulareinstellungen',
  ...
  'frm_id' => 'Form ID',
  'frm_invalid' => 'Das Formular enthä fehlende Einträ oder ungü Felder.',
  'frm_url' => 'Form URL',
  'group' => 'Gruppe',
  'hdr_field_edit' => 'Datenfelder bearbeiten.',
  'hdr_field_list' => 'Ein Datenfeld auswäen, um es zu bearbeiten. Um ein Neues zu erstellen, klickst Du auf "Neues Datenfeld" oben.',
  'hdr_form_list' => 'Ein Formular auswäen, um es zu bearbeiten. Um ein Neues zu erstellen, klickst Du auf "Neues Formular" oben.  Andere verfü Aktionen sind in der Auswahl unten aufgefü,',
  'hdr_form_preview' => 'Dies ist eine voll funktionsfäge Vorschau, wie das Formular aussieht.  Wenn Du die Datenfelder ausfü und den Button »Üertragen/Submit« klickst, werden die Daten gespeichert und/oder die Formularbesitzer per E-Mail benachrichtigt',
  'hdr_form_results' => 'Hier sind die Ergebnisse fü Formular.  Um Datenfelder zu löen, markiere die betreffenden Kontrollkächen und wäe "Löen".',
  'help_msg' => 'Help Text',
  'hidden' => 'Hidden',
  'hlp_edit_form' => 'Erstellen oder Bearbeiten eines bestehenden Formulares. Beim Erstellen eines Formulars, muss das Formular gespeichert werden, bevor Felder hinzugefürden kön.',
  ...
  'hlp_fld_mask' => 'Eingabeformate der Daten (z.B. "99999-9999" fü-Postleitzahl).',
  'hlp_fld_order' => 'Diese Auflistung zeigt die Zuordnung der Formularfeldnamen und der ihnen zugewiesenen Daten, Berechtigungen und Reihenfolge. Diese kön jederzeit geäert werden',
  'hlp_fld_value' => 'Die Bedeutung der Werte richtet sich nach dem Feldtyp:<br><ul><li>Neue Einträ: Standardwert fütfelder</li><li>aktiv = <b>1</b>: Standardwert fütrollkächen/Checkbox</li><li>Semikolongetrennte Eingabepaare (Wert [0..n]:Zeichenkette [a-z,A-Z,0-9]): Standardwert füionsfelder/Radiobutton. Folgendes Eingabeformat wird erwartet: <b>"Wert:Zeichenkette"</b> z.B.: "0:NEIN;1:JA;2:NIE;3:keine Sortierung;..."</li></ul>',
  'hour12' => '12h',
  'hour24' => '24h',
  ...
  'name' => 'Name',
  'never' => 'Never',
  'new_frm_saved_msg' => 'Formular gespeichert. Jetzt nach unten scrollen, um Datenfelder hinzuzufü',
  'no' => 'Nein',
  'noaccess_msg' => 'Du hast keine Berechtigung füses Formular',
...
'max_submit_msg' => 'Message if the max submissions is reached',
  ...
  'readonly' => 'nur lesen',
  'redirect' => 'URL nach Üertragung umleiten',
  'req_captcha' => 'Require CAPTCHA',
  'required' => 'erforderlich',
  'reset' => 'Formular zurüzen',
  ...
  'stripmask' => 'Feldmaskenformat füenwert aktivieren',
  ...
  'user_group' => 'Gruppe, die Formulare ausfükann',
...
$PLG_forms_MESSAGE1 = 'Vielen Dank für deinen Formularvorschlag.';
