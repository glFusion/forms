...
$LANG_FORMS = array(
  ...
  'cancel' => 'Abbruch',
  'columns' => 'Spalten',
  'confirm_delete' => 'Bist Du dir sicher, diesen Eintrag löschen zu wollen?',
  'confirm_form_delete' => 'Bist Du sicher, dass Du dieses Formular löschen willst? Alle zugehörigen Felder und Daten werden gelöscht.',
  'datetime' => 'Datum/Zeit',
  'day' => 'Tag',
  'def_submit_msg' => 'Danke für deinen Formularvorschlag',
  ...
  'hdr_field_list' => 'Ein Datenfeld auswählen, um es zu bearbeiten. Um ein Neues zu erstellen, klickst Du auf "Neues Datenfeld" oben.',
  'hdr_form_list' => 'Ein Formular auswählen, um es zu bearbeiten. Um ein Neues zu erstellen, klickst Du auf "Neues Formular" oben.  Andere verfügbare Aktionen sind in der Auswahl unten aufgeführt.',
  'hdr_form_preview' => 'Dies ist eine voll funktionsfähige Vorschau, wie das Formular aussieht.  Wenn Du die Datenfelder ausfüllstn und den Button »Ãertragen/Submit« klickst, werden die Daten gespeichert und/oder die Formularbesitzer per E-Mail benachrichtigt',
  'hdr_form_results' => 'Hier sind die Ergebnisse für das Formular.  Um Datenfelder zu löschen, markiere die betreffenden Kontrollkästchen und wähle "Löschen".',
  'help_msg' => 'Help Text',
  'hidden' => 'Hidden',
  ...
  'no' => 'Nein',
  'noaccess_msg' => 'Du hast keine Berechtigung für dieses Formular',
